		...
		<section style="padding-top: 120px; height: 1000px;" >
			<form action="/insertBInfo" method="post">
				<table class="manageTable" border="1">
					...
					<tr><td colspan="4"><a class="link-manage" href="/branchManage">취소</a><button class="btn-manage-modify" type="submit" id="submit">확인</button></td></tr>
				</table>
			</form>
			<br><br>
			<form action="/insertBiAndC" method="post" enctype="multipart/form-data">
				<table class="manageTable" border="1">
					<tr><td colspan="6">새 지점의 세부 정보 등록하기 <span class="important">(주의 : 지점 등록 이후에 세부정보 입력 가능)</span></td></tr>
					...
					<tr><td colspan="6"><button class="btn-manage-modify" type="submit" id="submit">확인</button></td></tr>
				</table>
			</form>
		</section>
	<script>
