				...
				<div
					...
					<div>
						...
						<button id="paymentBtn"
							style="width: 100px; height: 40px; border: 2px solid #2c3c57; background-color: #2c3c57; padding: 0; margin-top: 5px; font-weight: bolder; font-size: 16px; border-radius: 2px; line-height: 30px; color: white;float:right;">결제하기</button>
					</div>
				</div>
			</div>
		</div>
